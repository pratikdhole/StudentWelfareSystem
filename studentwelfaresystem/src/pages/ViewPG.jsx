      ...
      <div className="col-md-10 view-pg-section shadow-defaultCardShadow mt-3">
        ...
        <div className="pg-amount border-cardbordercolor d-flex ">
          <div className="col-md-4 text-center">
            <div className="font-semi-bold fontsme">2.5 Crores</div>
            <div className="dpname">Deposit</div>
          </div>
          <div className="col-md-4 text-center">
            <div className="font-semi-bold fontsme">Shared</div>
            <div className="dpname">Room Type Available</div>
          </div>
          <div className="col-md-4 text-center">
            <div className="font-semi-bold fontsme">₹3,500</div>
          ...
          <div className="dis-img">
            <div className="dis-img-section">
              ...
              {/* <div className="discrption-flow">
                ...
                <div class="flex">
                  <div>
                    <div class="font-semibold">Any</div>
                    <div class="">
                      <div class="heading-7 text-default-color mt-0.5p">
                        Preferred Tenants
                      </div>
